...
must_haves:
  truths:
    - "Cursor appears in focused Input at correct character position"
    - "Cursor disappears when Input loses focus"
    - "Block cursor inverts colors at cursor position"
    - "Bar cursor shows vertical line character"
    - "Underline cursor underlines the character at cursor position"
    - "Selected text appears with inverted colors"
  artifacts:
...
- [ ] Underline cursor uses UNDERLINE attribute
- [ ] Cursor appears in focused Input, disappears on blur
