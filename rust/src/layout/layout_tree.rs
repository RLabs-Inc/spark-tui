//! Layout Tree - Taffy integration with SharedBuffer (512-byte nodes)
//!
//! This module implements Taffy's low-level trait API using the new cache-aligned buffer layout.
//! Data is organized by access pattern for optimal cache utilization.
...
use crate::shared_buffer::{
    SharedBuffer, COMPONENT_BOX, COMPONENT_INPUT, COMPONENT_NONE, COMPONENT_TEXT,
};
